...
The app is Vite + Vue 3 + TypeScript. `Avatar` is the reusable SVG: pass `size`, `shape`, `expression`, `gaze`, and `colour`. The studio morphs that avatar and offers a right-rail palette of the 14 animation states. Later work adds the editor and export.
